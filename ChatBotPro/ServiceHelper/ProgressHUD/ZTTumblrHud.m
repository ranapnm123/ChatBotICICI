...
static ZTTumblrHud *_sharedInstance = nil;

@implementation ZTTumblrHud {
...
- (void)configUI {
    ...
    UIView *rect2 = [self drawRectAtPosition:CGPointMake(14, 0)];
    UIView *rect3 = [self drawRectAtPosition:CGPointMake(28, 0)];
...
- (void)animateRect:(UIView *)rect withDuration:(NSTimeInterval)duration {
    ...
    [UIView animateWithDuration:duration
                     animations:^{
                         rect.alpha = 1;
                         rect.transform = CGAffineTransformMakeScale(1.1, 1.1);
...
- (UIView *)drawRectAtPosition:(CGPoint)positionPoint {
    ...
    rect.backgroundColor = getColor(66.0, 177.0, 224.0, 1.0);
    rect.alpha = 0.5;
